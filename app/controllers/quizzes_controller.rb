class QuizzesController < ApplicationController
  ...
  def quiz_params
    params.require(:quiz).permit(:public, :title,,:randomize_questions,:submission_date,:total_marks,:submission_date, :quiz_question_attributes => [:marks], :question_attributes => [:id])
  end
