  ...
  def as_json(options={})
    {
        ...
        :quiz_assignments => @post.quiz_assignments.map {|p| p.as_api_response(:backbone)},
  ...
  def as_json(options={})
    {
        ...
        :comments => CommentPresenter.collection_json!(@post.comments.order('created_at ASC'), @current_user),
